...
export default {
    ...
    // api de geo_nodes para serem renomeadas - https://gitlab.com/gitlab-org/gitlab/-/issues/369140
    ...
    // projeto
    projectDeploymentFrequencyAnalyticsPath: '/api/:version/projects/:id/analytics/deployment_frequency',
    ...
    issueMetricSingleImagePath: '/api/:version/projects/:id/issues/:issue_iid/metric_images/:image_id',
    ...
    mrStatusCheckRetryPath: '/api/:version/projects/:id/merge_requests/:merge_request_iid/status_checks/:external_status_check_id/retry',
    ...
    uploadIssueMetricImage({
        ...
        // construir form de data multipart
    ...
    approveDeployment({
        ...
        return this.deploymentApproval({
            id,
            deploymentId,
            approve: true,
            comment
