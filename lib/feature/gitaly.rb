...
module Feature
    class Gitaly
        ...
        # wrapper para sinalizador de recurso para evitar consultas sql desnecessárias
        class ActorWrapper
        ...
        class << self
            ...
            def server_feature_flags(repository: nil, user: nil, project: nil, group: nil)
                # precisamos verificar se a conexão e a tabela do banco de dados existem
