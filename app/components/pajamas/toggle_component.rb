...
# renderizar elemento root gltoggle
# para atualmente incializar componente, certificar-se de chamar o helper inittoggle de ~/toggles
class Pajamas::ToggleComponent < Pajamas::Component
    ...
    def initialize(
        ...
        @label_position = filter_attribute(
            label_position,
