...
export default {
    fetchTypesErrorText: s__(
        'WorkItem|algo deu errado ao buscar tipos de item de trabalho. por favor, tente novamente'
    ),
    ...
    computed: {
        formOptions() {
            return [
                {
                    value: null,
                    text: s__('WorkItem|selecionar tipo')
                }, ...this.workItemTypes
            ];
        },
        ...
        async createStandaloneWorkItem() {
            try {
                ...
                this.$router.push({
                    ...
                    params: {
                        id: response.data.workItemCreate.workItem.iid
                    }
                });
            } catch {
    ...
    <form @submit.prevent="createWorkItem">
        ...
        <div class="gl-bg-gray-10 gl-py-5 gl-px-6 gl-mt-4">
            <gl-button
                ...
                type="submit"
            >
                {{ s__('WorkItem|criar item de trabalho') }}
            </gl-button>
